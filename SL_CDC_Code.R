...
splt_cdc <- lapply(1:folds, function(ind) D[index[[ind]],])
#--------------------------------------------------------------------------------------------------------------------------------------------------------------
#--------------------------------------------------------------------------------------------------------------------------------------------------------------
#--------------------------------------------------------------------------------------------------------------------------------------------------------------
...
m17 <- lapply(1:folds, function(ii) cv.glmnet(as.matrix(do.call(rbind,splt[-ii])[,-1]), as.matrix(do.call(rbind,splt[-ii])[,1]), alpha = 0, family="binomial",   standardize = FALSE))
m18 <- lapply(1:folds, function(ii) cv.glmnet(as.matrix(do.call(rbind,splt[-ii])[,-1]), as.matrix(do.call(rbind,splt[-ii])[,1]), alpha = 0.2, family="binomial", standardize = FALSE))
m19 <- lapply(1:folds, function(ii) cv.glmnet(as.matrix(do.call(rbind,splt[-ii])[,-1]), as.matrix(do.call(rbind,splt[-ii])[,1]), alpha = 0.4, family="binomial", standardize = FALSE))
m20 <- lapply(1:folds, function(ii) cv.glmnet(as.matrix(do.call(rbind,splt[-ii])[,-1]), as.matrix(do.call(rbind,splt[-ii])[,1]), alpha = 0.6, family="binomial", standardize = FALSE))
m21 <- lapply(1:folds, function(ii) cv.glmnet(as.matrix(do.call(rbind,splt[-ii])[,-1]), as.matrix(do.call(rbind,splt[-ii])[,1]), alpha = 0.8, family="binomial", standardize = FALSE))
m22 <- lapply(1:folds, function(ii) cv.glmnet(as.matrix(do.call(rbind,splt[-ii])[,-1]), as.matrix(do.call(rbind,splt[-ii])[,1]), alpha = 1.0, family="binomial", standardize = FALSE))
...
p23 <- lapply(1:folds, function(ii) KernelKnn(data=do.call(rbind,splt[-ii])[,-1],y=as.numeric(as.character(unlist(do.call(rbind,splt[-ii])[,1]))),
                                              TEST_data = do.call(rbind,splt[ii])[,-1], regression=T, k=2))
p24 <- lapply(1:folds, function(ii) KernelKnn(data=do.call(rbind,splt[-ii])[,-1], y=as.numeric(as.character(unlist(do.call(rbind,splt[-ii])[,1]))),
                                              TEST_data = do.call(rbind,splt[ii])[,-1],regression=T, k=3))
p25 <- lapply(1:folds, function(ii) KernelKnn(data=do.call(rbind,splt[-ii])[,-1], y=as.numeric(as.character(unlist(do.call(rbind,splt[-ii])[,1]))),
                                              TEST_data = do.call(rbind,splt[ii])[,-1],regression=T, k=4))
p26 <- lapply(1:folds, function(ii) KernelKnn(data=do.call(rbind,splt[-ii])[,-1], y=as.numeric(as.character(unlist(do.call(rbind,splt[-ii])[,1]))),
...
p27 <- lapply(1:folds, function(ii) do.call(rbind,splt_cdc[ii]) %>% 
...
write.csv(alpha, file="C:\\Users\\abc72\\Box Sync\\Dissertation backup\\Dissertation\\MOMI\\Exploratory data analysis\\alpha_varselection_noscreening_all_2020.07.31.csv")
#--------------------------------------------------------------------------------------------------------------------------------------------------------------
#--------------------------------------------------------------------------------------------------------------------------------------------------------------
#--------------------------------------------------------------------------------------------------------------------------------------------------------------
